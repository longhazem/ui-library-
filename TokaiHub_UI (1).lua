...
function Library:CreateWindow()
    ...
    lockBtn.MouseButton1Click:Connect(function()
        ...
        lockBtn.Image = isLocked and ICONS.lock or ICONS.unlock
    ...
    -- 2 vệt trắng ngắn đối xứng, nền đen = ẩn
    do
        ...
        function elements:AddDashboard()
            ...
            do
                local cloudData = {
                    ...
                    {x=90,y=64,w=70,h=70,a=0.30},{x=138,y=70,w=60,h=60,a=0.28},{x=180,y=65,w=66,h=66,a=0.30},
                }
                for _,cd in ipairs(cloudData) do
                    local c=Instance.new("Frame",clockBox); c.Size=UDim2.new(0,cd.w,0,cd.h); c.Position=UDim2.new(0,cd.x,0,cd.y)
                    c.BackgroundColor3=Color3.fromRGB(255,255,255); c.BackgroundTransparency=cd.a; c.ZIndex=1
